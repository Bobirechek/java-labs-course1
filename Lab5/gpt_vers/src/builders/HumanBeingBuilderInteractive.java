...
/**
 * Интерактивный билдер HumanBeing с полной валидацией
 */
public class HumanBeingBuilderInteractive {

    private final Scanner scanner;

    public HumanBeingBuilderInteractive(Scanner scanner) {
    ...
    private boolean readRealHero() {
        ...
        while (true) {
            ...
            System.out.println("Ошибка: допустимы только значения true или false.");
        }
    }
    ...
    private Boolean readHasToothpick() {
        ...
        while (true) {
            ...
            System.out.println("Введите hasToothpick (true/false) или пустую строку для null:");
            ...
            System.out.println("Ошибка: допустимы значения true, false или пустая строка.");
        }
    }
