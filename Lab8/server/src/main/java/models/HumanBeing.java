...
public class HumanBeing implements Comparable<HumanBeing>, Serializable {
    ...
    public static class Builder {
        ...
        public HumanBeing build() {return new HumanBeing(this);}
    }
    ...
    public int compareTo(HumanBeing o) {
        int cx = Double.compare(this.coordinates.getX(), o.coordinates.getX());
        if (cx != 0) {
            return cx;
        }
    ...
    public String toString() {
        return "Id - " + id +
               ...
               (car != null && car.getName() != null && !car.getName().isEmpty()
                       ? "\nCar - " + car.getName() + " (cool=" + car.getCool() + ")"
                       : "") +
               "\nOwner - " + (ownerLogin != null ? ownerLogin : "unknown");
    }
}